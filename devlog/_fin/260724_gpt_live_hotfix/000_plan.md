...
Branch/worktree: `codex/260724-gpt-live-hotfix` @ `/Users/jun/.codex/worktrees/260724-gpt-live-hotfix/OpenProvider`
...
OpenProvider is injected as `base_url` under Design B, then ship it as a hotfix
...
### 1.6 Release baseline (npm `@bitkyc08/OpenProvider`, verified 04:1x–04:3xZ)
...
2. **Manual runtime proof.** Automated tests + upstream-contract match are strong,
   but nobody has driven **real Codex App voice through opr** end-to-end yet
...
- **WP3 — (optional) manual voice smoke:** opr as injected base_url + ChatGPT
...
- **WP4 — Release train:** pick next unused patch from live npm/git; run
  ...
  GitHub Release / npm dist-tag / fresh `opr` runtime.
