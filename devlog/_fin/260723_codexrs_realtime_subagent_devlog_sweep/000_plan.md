...
2. **WP1 research docs** — write source-backed codex-rs/OpenProvider notes into this unit.
...
OUT:
- Implementing OpenProvider feature fixes discovered by research.
- Moving nested git checkouts (`opencode-cursor`, `_chase/*`) unless clearly finished plan docs (they are not finished OpenProvider plan units).
