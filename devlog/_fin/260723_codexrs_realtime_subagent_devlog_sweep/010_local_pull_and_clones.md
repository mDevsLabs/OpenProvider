...
## Why this matters for OpenProvider

OpenProvider does not vendor codex-rs. Compatibility work is catalog/config/Responses-proxy alignment against measured upstream contracts at this SHA.
