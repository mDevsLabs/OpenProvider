...
Create source-backed research artifacts in this unit from live local codex clones and OpenProvider source.
...
| `013_OpenProvider_impact.md` | NEW | Impact matrix against live OpenProvider files: `src/codex/catalog.ts`, `src/codex/features.ts`, `src/server/responses.ts`, `structure/03_catalog-and-subagents.md`. Mark each as already-handled / gap / out-of-scope. |
...
- `013_OpenProvider_impact.md`
- `014_open_leads.md`

All claims re-measured against clone tip `4462b9dee` and OpenProvider src on 2026-07-23.
