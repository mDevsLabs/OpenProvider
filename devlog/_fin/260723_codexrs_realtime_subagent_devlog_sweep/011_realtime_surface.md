...
## OpenProvider boundary

OpenProvider is a Responses-compatible local proxy. Realtime app-server methods are **not** implemented by OpenProvider. Relevant proxy obligations:
