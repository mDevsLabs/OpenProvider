...
| 396 | Cannot adjust thinking intensity in Claude Desktop | NOW bug | P2 | ccswitch shows it; OpenProvider path drops it. |
...
| 95 | Host OpenProvider as multi-user proxy (LiteLLM) | LATER roadmap | — | roadmap. |
