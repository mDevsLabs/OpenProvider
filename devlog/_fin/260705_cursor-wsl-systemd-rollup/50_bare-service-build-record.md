...
- `README.md`, `README.ko.md`, `README.zh-CN.md`: documented bare `opr service` as the service install/update/start path.
- `docs-site/src/content/docs/**/reference/cli.md`: documented `opr service [subcommand]`, added the no-subcommand row, and aligned `remove` alias tables.

## Audit Adjustments

- Kept `opr service start` installed-only, including the Linux systemd unit-file preflight.
