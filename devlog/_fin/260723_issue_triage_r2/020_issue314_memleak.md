...
- Author: BuSung-dev, 2026-07-23. Codex CLI, Windows 11, opr 2.7.31.
...
OpenProvider pins **Bun 1.3.14** (package.json engines + all CI workflows).
...
- **oven-sh/bun#32585** — pre-existing report *from an OpenProvider user*: Bun 1.3.14
  segfaults in a long-running OpenProvider localhost proxy on Windows 11; reporter's
