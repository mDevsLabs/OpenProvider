...
> Bound goalplan: `.codexclaw/goalplans/OpenProvider-bugfix-train-6-pabcd-cycles-bookkeepin/goalplan.json`
...
- Resource bounds: tools = local git/gh/bun + GitHub via gh; write scope = the
  opr-bugfix-train worktree + contributor PR branches (maintainerCanModify verified);
...
- One worktree: `/Users/jun/.codex/worktrees/opr-bugfix-train` (deps installed).
