...
- C gate: fresh sol reviewer (Archimedes) VERDICT: PASS, blockers none; independently confirmed
  ...
  Two prior C reviewers lost to transient opr stream disconnects (proxy health verified: /v1/models
...
- The RUNNING /opt/homebrew/bin/opr (pid 25337) still serves the old code; fix takes effect on
