...
```bash
gh issue view 418 --repo lidge-jun/OpenProvider --json number,title,state,labels,comments,url
```

Observed:

- Issue: https://github.com/lidge-jun/OpenProvider/issues/418
- State: `OPEN`
- Label: `bug`
...
Reviewed code still does not prove a local OpenProvider path that erases a non-empty
