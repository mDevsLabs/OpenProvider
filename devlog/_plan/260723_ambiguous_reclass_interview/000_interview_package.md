...
2. Branch: use existing dev worktree `/Users/jun/.codex/worktrees/f655/OpenProvider` (HEAD `dd8eda0f`, ahead origin/dev 3). Do **not** switch the main preview checkout.
