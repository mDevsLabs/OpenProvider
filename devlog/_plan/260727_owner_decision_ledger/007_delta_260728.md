...
| # | 제목 | 작성자 | 상태 | 규모 | 결정 축 |
| --- | --- | --- | --- | --- | --- |
| 568 | `feat(cli): add opr opencode launcher` | Wibias | ready, MERGEABLE/UNSTABLE, enhancement | +763/-0, 6f | **Q5 표면 확장**. 닫힌 #461의 대체본 |
...
| Q5 `opr opencode` | 대상이 #461 → **#568**. ready 상태라 방치 비용이 더 크다 |
| Q6 실행 권한 | 변화 없음 |
