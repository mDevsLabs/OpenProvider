...
Snapshot command: `gh pr list --repo lidge-jun/OpenProvider --state open --limit 200`
...
| 461 | draft | dev | feat/opr-opencode | `5ef84f48` | CONFLICTING/DIRTY | none | CI success on old head | enhancement | later/enhancement | new launcher/client support surface; draft and conflicting |
