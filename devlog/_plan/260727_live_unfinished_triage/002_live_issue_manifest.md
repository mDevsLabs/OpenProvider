...
Snapshot command: `gh issue list --repo lidge-jun/OpenProvider --state open --limit 200`
...
| --- | --- | --- | --- | --- |
| 547 | bug | 2026-07-27T10:38:50Z | comment/request-changes | new Windows Claude Desktop custom-model visibility report; needs exact generated config/profile path, `opr claude desktop` output, and Desktop dev-mode/API-key shape |
...
| 543 | bug, provider-compatibility, needs-info | 2026-07-27T08:34:24Z | comment/request-changes | reporter supplied native control; we can answer with existing `opr debug claude` capture switch |
| 540 | enhancement, provider-compatibility, roadmap | 2026-07-27T08:09:26Z | later/enhancement | valid provider request but gated on official Automattic/OpenProvider auth contract |
...
| 417 | bug, upstream-tracking | 2026-07-24T18:31:11Z | upstream-tracking | Korean realtime transcript corruption tracked upstream; not an opr relay fix yet |
