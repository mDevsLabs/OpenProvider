...
the companion look like a third-party utility rather than part of OpenProvider.

## 2. Design Read

```yaml
---
name: OpenProvider-menubar
colors:
...
runs**, in the visual language of the existing OpenProvider dashboard, compressed to a
340pt popover.
