...
- Worktree: `/Users/jun/.codex/worktrees/260727-desktop3p-path/OpenProvider`
...
- PR: https://github.com/lidge-jun/OpenProvider/pull/552
...
- `src/claude/desktop-3p-paths.ts`
  - Replaced host `node:path.join` use in Desktop 3P resolver with target-platform
    `posix` / `win32` joins.
  - Preserved `OpenProvider_CLAUDE_DESKTOP_CONFIG_DIR` trim-then-verbatim override.
