...
beforeEach(() => {
  ...
  isolatedCodexHome = installIsolatedCodexHome("opr-kiro-401-codex-");
  testDir = mkdtempSync(join(tmpdir(), "opr-kiro-401-"));
  emptyHome = mkdtempSync(join(tmpdir(), "opr-kiro-401-home-"));
