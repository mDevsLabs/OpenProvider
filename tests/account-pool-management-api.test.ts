...
function makeCodexConfig(overrides: Partial<oprConfig> = {}): oprConfig {
  return {
    port: 10100,
    providers: {},
...
describe("Anthropic account pool strategy management API", () => {
  ...
  beforeEach(() => {
    ...
    isolatedCodexHome = installIsolatedCodexHome("opr-pool-mgmt-codex-");
    testDir = mkdtempSync(join(tmpdir(), "opr-pool-mgmt-"));
