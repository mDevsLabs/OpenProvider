...
import type { oprConfig, oprProviderConfig, oprParsedRequest } from "../../src/types";
...
function makeConfig(
  providers: Record<string, Partial<oprProviderConfig>>,
...
function makeParsed(withImageGen: boolean): oprParsedRequest {
  return {
    modelId: "test-model",
...
const routed = { adapter: "openai-chat", baseUrl: "https://api.anthropic.com" } as oprProviderConfig;
const openaiRouted = { adapter: "openai-chat", baseUrl: "https://api.openai.com" } as oprProviderConfig;
