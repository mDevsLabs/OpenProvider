...
beforeEach(() => {
  ...
  previousCursorToken = process.env.OPENPROVIDER_CURSOR_TEST_TOKEN;
...
afterEach(async () => {
  ...
  if (previousCursorToken === undefined) delete process.env.OPENPROVIDER_CURSOR_TEST_TOKEN;
  else process.env.OPENPROVIDER_CURSOR_TEST_TOKEN = previousCursorToken;
