 ...
 *
 * Change vs source: the success/error page is an inline HTML constant. openprovider's GUI polls
...
const SUCCESS_HTML =
  "<!doctype html><html><head><meta charset='utf-8'><title>openprovider</title></head>" +
  "<body style='font-family:system-ui,sans-serif;text-align:center;padding:4rem;color:#111'>" +
  "<h2>&#9989; Login complete</h2><p>You can close this tab and return to openprovider.</p></body></html>";
