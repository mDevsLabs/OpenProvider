...
export function effortCapFor(config: oprConfig, subagent: boolean): string | undefined {
  const caps: string[] = [];
 ...
 */
export function supportedLadderFor(route: { provider: oprProviderConfig; modelId: string }): string[] | undefined {
