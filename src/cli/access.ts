...
const USAGE = `Usage:
  opr access key [list] [--json]
  opr access key create [name] [--json]
  opr access key remove <id> --yes [--json]
  opr access endpoints [--json]
  opr access models [--json]
  opr access test <model> [--protocol <chat|responses|messages>] [--json]`;
