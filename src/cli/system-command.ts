...
const USAGE = `Usage:
  opr system [status] [--json]
  opr system settings [--auto-start <on|off>] [--stream-mode <auto|legacy-tee|eager-relay>] [--json]
  opr system startup <health|install-service|install-shim> [--json]
  opr system diagnostics [--json]
  opr system sync [--json]
  opr system update check [--channel <latest|preview>] [--json]
  opr system update run [--channel <latest|preview>] [--restart <on|off>] --yes [--json]
  opr system update status <job-id> [--json]`;
