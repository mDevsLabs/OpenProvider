...
const USAGE = `Usage:
  opr provider edit <name> [--adapter <id>] [--base-url <url>] [--default-model <id|->]
  ...
  opr provider test <name> [--json]
  opr provider quota [--refresh] [--json]
  opr provider presets [--json]
  opr provider account-mode <pool|direct> [--json]
  opr provider selected <name> [--set <model,model...>] [--clear] [--json]`;
