...
**Адаптер** выполняет преобразование между внутренней моделью запросов/ответов OpenProvider и
...
Только при полном отсутствии stop reason OpenProvider добавляет приватный инструмент
