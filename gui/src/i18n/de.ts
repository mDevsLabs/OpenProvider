...
export const de: Record<TKey, string> = {
  ...
  "startup.subtitle": "Prüft, ob Codex OpenProvider nach einem Neustart erreicht, bevor lokales Proxy-Routing in einer Wiederverbindungsschleife endet.",
  ...
  "startup.summary.protected": "OpenProvider ist nach einem Neustart verfügbar",
  ...
  "startup.riskDetailCustomLocal": "Codex verwendet ein benutzerdefiniertes lokales Gateway. OpenProvider kann dessen Neustart-Lebenszyklus weder verwalten noch prüfen.",
  ...
  "startup.safeDetail": "Routing und Startmechanismus stimmen überein. Nach einem Neustart sollte kein manuelles opr start nötig sein.",
  ...
  "startup.shimHint": "Führt opr ensure aus, wenn ein unterstützter Codex-Skript-Launcher startet.",
  ...
  "startup.tray.error": "Die Windows-Infobereichsaktion ist fehlgeschlagen. Details: opr tray status.",
  ...
  "startup.codexRuntime.clampHidden": "Einige Reasoning-Effort-Optionen wurden ausgeblendet, weil OpenProvider Codex {version} verwendet hat.",
  "startup.codexRuntime.clampHiddenWithEfforts": "Einige Reasoning-Effort-Optionen wurden ausgeblendet, weil OpenProvider Codex {version} verwendet hat (entfernt: {efforts}).",
  "startup.codexRuntime.olderBinary": "OpenProvider verwendet eine ältere Codex-Binary ({version}). Eine neuere Installation ist verfügbar.",
  "dash.subtitle": "Live-Status des lokalen OpenProvider-Proxys, seiner Anbieter und der in Codex gerouteten Modelle.",
  ...
  "dash.codexAutoStart": "OpenProvider mit Codex starten",
  "dash.codexAutoStartHint": "Erlaubt einem installierten Launcher-Shim, opr ensure auszuführen. Diese Einstellung installiert keinen Neustartschutz; prüfe den effektiven Zustand unter Startsicherheit.",
  ...
  "dash.maintenanceHint": "Aktualisiere Codex’ Modellkatalog oder installiere eine neuere OpenProvider-Version.",
  ...
  "dash.projectConfigTitle": "Projekt-Codex-Konfig umgeht OpenProvider",
  "dash.projectConfigHint": "Diese repo-lokalen Einstellungen überschreiben den OpenProvider-Proxy (z. B. direkt zu OpenCode Go routen). Entferne sie, damit die Routing aus ~/.codex/config.toml in diesem Projekt greift.",
  "dash.checkUpdate": "Update prüfen",
  "dash.updateTitle": "OpenProvider aktualisieren",
  ...
  "dash.updateStatus.running": "OpenProvider wird aktualisiert.",
  ...
  "prov.subtitle": "Konfiguriere die Upstream-Anbieter, die OpenProvider in Codex routet. Melde dich mit einem Konto an, füge einen Anbieter hinzu oder bearbeite die Rohkonfiguration.",
  ...
  "oauthTos.anthropicBody": "Die direkte Wiederverwendung von Claude-Abo-OAuth-Tokens über einen Drittanbieter-Proxy wie OpenProvider ist keine von Anthropic unterstützte Integration und kann zu Zugriffsbeschränkungen führen. Unterstützte Agent-SDK-Integrationen, die Claude-Abos verwenden, sind davon getrennt.",
  "oauthTos.highBody": "OpenProvider verbindet {provider} über einen OAuth-Pfad eines Drittanbieters. Bei nicht unterstützter Nutzung kann der Zugriff eingeschränkt oder gesperrt werden.",
  "oauthTos.elevatedBody": "OpenProvider verbindet {provider} über einen inoffiziellen OAuth-Pfad. Nutze nach Möglichkeit den offiziellen Client; ungewöhnlicher oder automatisierter Traffic kann als Missbrauch gewertet und der Zugriff eingeschränkt oder gesperrt werden.",
  "oauthTos.saferPath": "Sicherere Option: Hinterlege stattdessen einen API-Schlüssel in OpenProvider.",
  ...
  "models.subtitle": "Steuere, welche Modelle Codex sieht — natives GPT-Passthrough und geroutete Anbieter, nach Anbieter gruppiert (Kopfzeile zum Einklappen anklicken). Deaktivierte Modelle sind im Katalog und in der Modellauswahl verborgen. Änderungen gelten bei der nächsten Codex-Runde — OpenProvider invalidiert Codex 5-Minuten-Modell-Cache, kein Neustart nötig.",
  ...
  "sub.subtitle": "Codex {cmd} bewirbt nur die ersten 5 Modelle (nach Priorität) als Overrides. Wähle hier bis zu 5 — natives gpt oder geroutet — und OpenProvider setzt ihre Katalog-Priorität, sodass genau diese führen. Jedes andere Modell bleibt über seinen exakten Namen aufrufbar; dies steuert nur die Anzeige.",
  ...
  "logs.subtitle": "Letzte Anfragen über den lokalen OpenProvider-Proxy, neueste zuerst.",
  ...
  "api.subtitle": "Nutze generierte API-Schlüssel, um von externen Apps auf den OpenProvider-Proxy zuzugreifen. Schlüssel authentifizieren über den {authHeader}- oder {altHeader}-Header.",
  ...
  "api.authResponses": "Responses-Anfragen sollten x-OpenProvider-api-key verwenden, weil der Authorization-Header für Codex Direct reserviert sein kann.",
  "api.authChatCompletions": "Chat Completions und /v1/models akzeptieren Authorization: Bearer ocx_... oder x-OpenProvider-api-key.",
  "api.authMessages": "Messages akzeptiert Authorization: Bearer ocx_... oder x-OpenProvider-api-key.",
  "api.authLoopback": "Loopback-Binds (127.0.0.1 oder ::1) umgehen die Authentifizierung. Remote-Binds benötigen einen generierten ocx_-Schlüssel oder OpenProvider_API_AUTH_TOKEN.",
  ...
  "claude.injectAgentsDesc": "Registriert die im Subagenten-Tab gewählten Modelle (plus das aktuelle Standardmodell) als aufrufbare Claude-Code-Agenten (opr-*). Gilt ab der nächsten Sitzung.",
  ...
  "common.ok": "OK",
  "app.logoAria": "OpenProvider-Logo",
 ...
 "pws.noModelMatch": "Keine Modelle entsprechen dem Filter.",
  ...
  "pws.copyDoctor": "opr doctor kopieren",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "cws.howBody": "Fordern Sie in Codex den öffentlichen Modellnamen der Combo an. Ohne eigenen Namen gilt combo/<id>. OpenProvider wählt ein Ziel und springt nur bei wiederholbaren Upstream-Fehlern. Ist kein Ziel verfügbar, schlägt die Anfrage geschlossen fehl, statt den globalen Standardanbieter zu verwenden.",
  ...
  "grok.subtitle": "Modelle, die OpenProvider in deiner Grok-Konfiguration registriert hat.",
  ...
  "grok.notConfiguredHint": "Starte den Proxy mit installiertem Grok neu; OpenProvider schreibt dann einen verwalteten Block nach:",
